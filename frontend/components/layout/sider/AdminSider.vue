  ...
  <a-layout-sider width="200" style="background: #fff">
    <a-menu mode="inline"
      ...
      <a-sub-menu v-for="page in pages" :key="page.name">
          <span slot="title"><a-icon :type="page.icon"/>
            <nuxt-link :to="mainPath + page.path">
                {{ page.name }}
          </nuxt-link>
          </span>
        <a-menu-item v-for="subPage in page.subPages" :key="subPage.name">
      ...
      <a-menu-item v-for="singlePage in singlePages" :key="singlePage.name">
