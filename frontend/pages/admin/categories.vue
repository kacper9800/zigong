<template>
  <div class="page" style="max-height: 40vh !important">
    ...
    <a-table :columns="columns" :data-source="categories" bordered>
      ...
      <span slot="homePageDescriptionCustomTitle">{{$t(`categories.modal.homePageDescription`)}}</span>
      <a slot="actions" slot-scope="text">
        <img :src="require('../../assets/images/flags/english-flag.png')" @click="openEditModalWithTranslations('en')"/>
        <img :src="require('../../assets/images/flags/russian-flag.png')" @click="openEditModalWithTranslations('ru')"/>
        <img :src="require('../../assets/images/flags/polish-flag.png')" @click="openEditModalWithTranslations('pl')"/>
